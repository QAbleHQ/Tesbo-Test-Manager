...
export const metadata: Metadata = {
  title: "Privacy Policy | BetterCases",
  description: "Privacy Policy for BetterCases and Jira integration.",
};
      ...
      <div className="mx-auto max-w-3xl px-6 py-10">
        ...
        <div className="mt-8 space-y-6 text-sm leading-7 text-zinc-700 dark:text-zinc-300">
          <section>
            ...
            <p className="mt-2">
              This Privacy Policy explains how BetterCases collects, uses, stores, and shares information when you use
              the BetterCases web application, including Jira integration features made available through Atlassian.
            </p>
          </section>
          ...
          <section>
            ...
            <ul className="mt-2 list-disc pl-5 space-y-1">
              ...
              <li>
                ...
                between Jira issues and BetterCases records.
              </li>
          ...
          <section>
            ...
            <p className="mt-2">
              When a workspace administrator connects Jira, BetterCases receives and stores OAuth credentials and
              selected Jira project and issue data needed for integration features. We use this data only to provide
              Jira-related functionality inside BetterCases, such as synchronization and issue linking.
            </p>
          </section>
          ...
          <section>
            ...
            <p className="mt-2">Depending on configuration, BetterCases may use third-party providers for:</p>
            <ul className="mt-2 list-disc pl-5 space-y-1">
          ...
          <section>
            ...
            <p className="mt-2">
              ...
              BetterCases, to comply with legal obligations, or based on your workspace configuration and user actions.
            </p>
          </section>
          ...
          <section>
            ...
            <p className="mt-2">
              BetterCases applies technical and organizational controls designed to protect stored information. No
