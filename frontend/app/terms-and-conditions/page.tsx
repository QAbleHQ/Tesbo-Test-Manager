...
export const metadata: Metadata = {
  title: "Terms and Conditions | BetterCases",
  description: "Terms and Conditions for BetterCases and Jira integration.",
};
      ...
      <div className="mx-auto max-w-3xl px-6 py-10">
        ...
        <div className="mt-8 space-y-6 text-sm leading-7 text-zinc-700 dark:text-zinc-300">
          <section>
            ...
            <p className="mt-2">
              By using BetterCases, you agree to these Terms and Conditions. If you do not agree, do not use the
              service.
            </p>
          </section>
          ...
          <section>
            ...
            <p className="mt-2">
              BetterCases is a test management and collaboration platform that includes project workspaces, test case
          ...
          <section>
            ...
            <p className="mt-2">
              You retain ownership of the data you submit to BetterCases, including test artifacts and Jira-linked
              records. You grant BetterCases a limited right to process this data only as needed to operate and improve
              the service.
            </p>
          </section>
          ...
          <section>
            ...
            <p className="mt-2">
              If you connect Jira, you authorize BetterCases to access and process Jira data that you permit through
          ...
          <section>
            ...
            <p className="mt-2">
              We may modify, suspend, or discontinue parts of BetterCases from time to time. We aim to maintain
          ...
          <section>
            ...
            <p className="mt-2">
              BetterCases is provided on an &quot;as is&quot; and &quot;as available&quot; basis to the fullest extent permitted by
          ...
          <section>
            ...
            <p className="mt-2">
              To the maximum extent permitted by law, BetterCases and its affiliates are not liable for indirect,
          ...
          <section>
            ...
            <p className="mt-2">
              We may update these terms periodically. Continued use of BetterCases after updates means you accept the
              revised terms.
            </p>
          </section>
