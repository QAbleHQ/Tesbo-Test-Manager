...
public final class AutomationQueueAutoscalingService {
    public static Map<String, Object> recommendWorkers() {
        ...
        int pendingBullDispatch = AutomationExecutionQueueService.countGlobalPendingBullDispatch();
        ...
        int pressureJobs = queuedJobs + Math.max(0, runningJobs / 2) + pendingBullDispatch;
        ...
        out.put("pendingBullDispatch", pendingBullDispatch);
