...
export { default as DetailWorkspaceLayout } from "@/components/workflows/DetailWorkspaceLayout";
export { default as SplitWorkspace } from "@/components/workflows/SplitWorkspace";
